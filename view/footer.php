...
<div class="footer_area">
		...
		<!-- all js here -->
        <script src="templatefree\assets\js\vendor\jquery-1.12.0.min.js"></script>
        <script src="templatefree\assets\js\popper.js"></script>
        <script src="templatefree\assets\js\bootstrap.min.js"></script>
        <script src="templatefree\assets\js\ajax-mail.js"></script>
        <script src="templatefree\assets\js\plugins.js"></script>
        <script src="templatefree\assets\js\main.js"></script>
    </body>
</html>
