                                        ...
                                        <div class="product_tab fix"> 
                                            <div class="product_tab_button">    
                                                <ul class="nav" role="tablist">
                                                    <li>
                                                        <a class="active" data-toggle="tab" href="#p_tab1" role="tab" aria-controls="p_tab1" aria-selected="false"><img src="templatefree\assets\img\cart\cart.jpg" alt=""></a>
                                                    </li>
                                                    <li>
                                                         <a data-toggle="tab" href="#p_tab2" role="tab" aria-controls="p_tab2" aria-selected="false"><img src="templatefree\assets\img\cart\cart2.jpg" alt=""></a>
                                                    </li>
                                                    <li>
                                                       <a data-toggle="tab" href="#p_tab3" role="tab" aria-controls="p_tab3" aria-selected="false"><img src="templatefree\assets\img\cart\cart4.jpg" alt=""></a>
                                                    </li>
                                                </ul>
                                            </div> 
                                            <div class="tab-content produc_tab_c">
                                                <div class="tab-pane fade show active" id="p_tab1" role="tabpanel">
                                                    <div class="modal_img">
                                                        <a href="#"><img src="templatefree\assets\img\product\product13.jpg" alt=""></a>
                                                        <div class="img_icone">
                                                           <img src="templatefree\assets\img\cart\span-new.png" alt="">
                                                       </div>
                                                        <div class="view_img">
                                                            <a class="large_view" href="templatefree\assets\img\product\product13.jpg"><i class="fa fa-search-plus"></i></a>
                                                        </div>    
                                                    </div>
                                                </div>
                                                <div class="tab-pane fade" id="p_tab2" role="tabpanel">
                                                    <div class="modal_img">
                                                        <a href="#"><img src="templatefree\assets\img\product\product14.jpg" alt=""></a>
                                                        <div class="img_icone">
                                                           <img src="templatefree\assets\img\cart\span-new.png" alt="">
                                                       </div>
                                                        <div class="view_img">
                                                            <a class="large_view" href="templatefree\assets\img\product\product14.jpg"><i class="fa fa-search-plus"></i></a>
                                                        </div>     
                                                    </div>
                                                </div>
                                                <div class="tab-pane fade" id="p_tab3" role="tabpanel">
                                                    <div class="modal_img">
                                                        <a href="#"><img src="templatefree\assets\img\product\product15.jpg" alt=""></a>
                                                        <div class="img_icone">
                                                           <img src="templatefree\assets\img\cart\span-new.png" alt="">
                                                       </div>
                                                        <div class="view_img">
                                                            <a class="large_view" href="templatefree\assets\img\product\product15.jpg"> <i class="fa fa-search-plus"></i></a>
                                                        </div>     
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="single_product">
                                            <div class="product_thumb">
                                               <a href="single-product.html"><img src="templatefree\assets\img\product\product1.jpg" alt=""></a> 
                                               <div class="img_icone">
                                                   <img src="templatefree\assets\img\cart\span-new.png" alt="">
                                               </div>
                                            ...
                                            <div class="product_content">
                                                ...
                                                <h3 class="product_title"><a href="templatefree\single-product.html">Curabitur sodales</a></h3>
                                            </div>
                            ...
                            <div class="row">
                                <div class="single_p_active owl-carousel">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="single_product">
                                            <div class="product_thumb">
                                               <a href="single-product.html"><img src="templatefree\assets\img\product\product5.jpg" alt=""></a> 
                                               <div class="hot_img">
                                                   <img src="templatefree\assets\img\cart\span-hot.png" alt="">
                                               </div>
                                               <div class="product_action">
